...
// 上下文信息
func (r ApiApiDevGenTokenPostRequest) ContextValue(contextValue string) ApiApiDevGenTokenPostRequest {
	r.contextValue = &contextValue
	return r
}

// 随机字符串，加密因子。需要32位长度以上
func (r ApiApiDevGenTokenPostRequest) RandomStr(randomStr string) ApiApiDevGenTokenPostRequest {
	r.randomStr = &randomStr
	return r
}
...
func (a *DevApiService) ApiDevGenTokenPostExecute(r ApiApiDevGenTokenPostRequest) (*ApiDevGenTokenPost200Response, *http.Response, error) {
	...
	if r.contextValue == nil {
		return localVarReturnValue, nil, reportError("contextValue is required and must be specified")
	}
	if r.randomStr == nil {
		return localVarReturnValue, nil, reportError("randomStr is required and must be specified")
	}
	...
	parameterAddToHeaderOrQuery(localVarFormParams, "contextValue", r.contextValue, "")
	parameterAddToHeaderOrQuery(localVarFormParams, "randomStr", r.randomStr, "")
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, formFiles)
	if err != nil {
		return localVarReturnValue, nil, err
	}
